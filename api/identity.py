...
if __name__ == '__main__':
    ...
    # print(IdNumber(idnumber).get_age())  # 年龄:23(岁)
    # print(IdNumber(idnumber).get_sex())  # 性别:1(男)
    # print(IdNumber(idnumber).get_check_digit())  # 校验码:7
    # print(IdNumber.verify_id(idnumber))  # 检验身份证是否正确:False
